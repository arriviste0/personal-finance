        ...
        <Card className={cn(
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {tags.map(tag => (
                <span key={tag} className={cn("text-xs font-medium px-3 py-1 border-2 border-chorke-dark-text bg-white/80 text-chorke-dark-text hover:bg-chorke-dark-text hover:text-white hover:border-white transition-all duration-150 cursor-pointer font-sans no-underline rounded-none")}>{tag}</span>
              ))}
            </div>
          </div>
        </Card>
...
const planSteps = [
  { step: 1, title: "Set Your Goals", description: "Define your financial objetives", icon: Target, color: "orange", borderColor: "border-chorke-accent-yellow", iconColor: "text-chorke-accent-yellow", badgeBg: "bg-chorke-accent-yellow" },
  { step: 2, title: "Get a Tailored Action Plan", description: "Receive a step-by-step plan", icon: BarChartBig, color: "blue", borderColor: "border-chorke-accent-blue", iconColor: "text-chorke-accent-blue", badgeBg: "bg-chorke-accent-blue" },
  { step: 3, title: "Track What Works", description: "Adjust and optimize your plan", icon: TrendingUp, color: "purple", borderColor: "border-chorke-accent-pink", iconColor: "text-chorke-accent-pink", badgeBg: "bg-chorke-accent-pink" },
  { step: 4, title: "Achieve & Grow", description: "Celebrate milestones and continue building your financial future.", icon: Award, color: "green", borderColor: "border-chorke-accent-green", iconColor: "text-chorke-accent-green", badgeBg: "bg-chorke-accent-green" },
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-chorke-dark-bg text-chorke-text-primary">
      <main className="flex-grow">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight font-heading text-chorke-accent-yellow">
                Engineering a new <span className="text-chorke-text-primary">economic paradigm</span>
              </h1>
              <p className="text-lg text-chorke-text-secondary max-w-xl">
                At FinCo (formerly Chorke), we are pioneering next-generation financial solutions. Our platform integrates asset management, investment banking, and venture capital to empower your financial journey.
              </p>
            ...
            >
              ...
              <Image
                ...
                alt="Financial technology abstract graphic"
                width={600}
                height={500}
              ...
              {[
                ...
                return (
                  <motion.div
                    ...
                    className="chorke-card group border-2 border-transparent hover:border-yellow-500 transition-colors duration-200 rounded-none"
                  >
                    ...
                    <p className="text-chorke-text-secondary group-hover:text-yellow-500 transition-colors duration-200">{item.description}</p>
                  </motion.div>
                );
              })}
            </div>
        ...
        <SectionWrapper id="financial-plan" bgClassName="bg-chorke-dark-bg" showShapes>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="hidden md:block absolute inset-0 flex items-center justify-center -z-10 pointer-events-none">
              <div className="w-[calc(100%-4rem)] h-[calc(100%-4rem)] sm:w-[520px] sm:h-[520px] border-[10px] border-chorke-accent-yellow/10 rounded-full opacity-70"></div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-16 relative z-10 justify-items-center">
              {planSteps.map((step, index) => {
                const StepIcon = step.icon;
                const cardOrder = [0, 1, 3, 2]; // Maps step index to visual grid order for clockwise
                ...
                return (
                  ...
                  >
                    <div className={cn(
                        "relative bg-chorke-card-bg p-6 rounded-none shadow-lg text-center flex flex-col items-center justify-start border-2 hover:shadow-2xl hover:border-chorke-text-primary transition-all duration-300 h-full",
                      ...
                      <h3 className="text-xl font-bold mb-2 font-heading text-chorke-text-primary">{`Step ${stepData.step}: ${stepData.title}`}</h3>
            ...
            {/* Arrows for visual flow - adjusted for clockwise-ness */}
        ...
        <SectionWrapper id="savings-potential" bgClassName="bg-chorke-card-bg" showShapes>
          <div className="container-default text-center relative">
             {/* Decorative Coin-like Icons */}
             <motion.div
                className="absolute top-[5%] left-[10%] w-16 h-16 sm:w-20 sm:h-20 z-0"
              ...
              <motion.div
                className="absolute top-[10%] right-[12%] w-12 h-12 sm:w-16 sm:h-16 z-0"
              ...
              <motion.div
                className="absolute bottom-[15%] left-[15%] w-10 h-10 sm:w-12 sm:h-12 z-0"
                animate={{ x: [0, 5, -5, 0], scale: [1, 1.05, 1] }}
                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", repeatType: "reverse" }}
              >
                <Cloud className="w-full h-full text-chorke-text-secondary opacity-60" />
              </motion.div>
               <motion.div
                className="absolute top-[20%] right-[5%] w-14 h-14 sm:w-16 sm:h-16 z-0"
              ...
              >
               ...
               <motion.div
                className="absolute bottom-[20%] right-[20%] w-12 h-12 sm:w-14 sm:h-14 z-0"
                animate={{ x: [0, -5, 5, 0], scale: [1, 0.95, 1] }}
        ...
        <SectionWrapper id="join-cta" bgClassName="bg-chorke-accent-yellow" showShapes>
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Join Fin.Co Today and Take Control of Your Financial Journey.
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
       ...
       <footer className="bg-chorke-card-bg text-chorke-text-secondary py-12 sm:py-16 border-t-2 border-chorke-card-border">
        <div className="container-default">
          <div className="grid lg:grid-cols-[2fr_1fr_1fr] gap-8 md:gap-12 mb-10"> {/* Updated grid columns */}
            <div className="lg:pr-8">
              <Link href="/" className="flex items-center space-x-2 no-underline mb-4">
                ...
                <span className="text-2xl font-bold font-heading text-chorke-text-primary">Fin.Co</span>
              </Link>
              <p className="text-sm">Get weekly financial tips and Fin.Co updates straight to your inbox.</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/#services" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">Features</Link></li>
                <li><Link href="/#pricing" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">Pricing</Link></li>
                <li><Link href="/about" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">About</Link></li>
                <li><Link href="/careers" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">Jobs</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-base font-semibold text-chorke-text-primary mb-4 font-heading">Resources</h4>
              <ul className="space-y-2">
                <li><Link href="/blog" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">Blog</Link></li>
                <li><Link href="/faq" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">FAQ</Link></li>
                <li><Link href="/support" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">Support</Link></li>
                <li><Link href="/contact" className="text-white hover:text-yellow-400 transition-colors no-underline text-sm">Contact Us</Link></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-chorke-card-border pt-8 flex flex-col sm:flex-row justify-between items-center text-sm">
            <p className="text-chorke-text-secondary/70 mb-4 sm:mb-0">&copy; {new Date().getFullYear()} Fin.Co. All Rights Reserved.</p>
