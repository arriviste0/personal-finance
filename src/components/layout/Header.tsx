  ...
  return (
     <header className="sticky top-0 z-50 w-full border-b bg-background shadow-sm">
      <div className="container flex h-16 max-w-screen-2xl items-center px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center space-x-2 no-underline mr-6 shrink-0">
           <CircleDollarSign className="h-7 w-7 text-brand-dark" />
           <span className="font-sans text-xl font-bold text-brand-dark">Fin.Co</span>
        </Link>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center space-x-1 lg:space-x-2 flex-grow">
          {navLinks.map(link => (
        ...
        <div className="hidden md:flex items-center space-x-3 ml-auto shrink-0">
           ...
           {isAuthenticated ? (
             ...
             <>
               <Link href="/login" passHref className="no-underline">
                  <Button variant="ghost" size="sm" className="text-foreground/80 hover:text-primary hover:bg-transparent px-3">Log In</Button>
               </Link>
               <Link href="/get-started" passHref className="no-underline">
                  <Button variant="primary" size="sm" className="retro-button !bg-primary hover:!bg-primary/90 !text-primary-foreground">Get Started</Button>
               </Link>
             </>
           )}
        </div>
