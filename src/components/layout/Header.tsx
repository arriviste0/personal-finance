  ...
  return (
     <header className="w-full bg-background shadow-sm">
      <div className="container max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        ...
        {/* Bottom Row - Boxed Sticky Navigation */}
           ...
           <div className="container max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between border border-border rounded-md shadow-sm bg-background px-2 lg:px-3 py-1.5">
              ...
              <div className="flex items-center space-x-2.5">
                 <Link href="#" aria-label="Twitter" className="text-foreground/60 hover:text-primary transition-colors no-underline"><Twitter className="h-4 w-4"/></Link>
                 <Link href="#" aria-label="Facebook" className="text-foreground/60 hover:text-primary transition-colors no-underline"><Facebook className="h-4 w-4"/></Link>
                 <Link href="#" aria-label="Instagram" className="text-foreground/60 hover:text-primary transition-colors no-underline"><Instagram className="h-4 w-4"/></Link>
              </div>
            </div>
          </div>
        </div>
